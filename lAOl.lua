...
function Man (name) 
  ...
  Join the lAOl community. Mint $lAOl Tokens using $CRED, then Stake them for voting on the Webpage to show
    on the lAOl page.
 ...
 # Mint
  ...
  ```
  Send({Target = CRED, Action = "Transfer", Quantity = "1000", Recipient = lAOl  })
  ```

  ## Stake

  ```
  Send({Target = lAOl, Action = "Stake", Quantity = "1000", UnstakeDelay = "1000"})
  ```

  ## Vote

  ```
  Send({Target = lAOl, Action = "Vote", Side = "yay", VoteID = "{TXID}" })
  ```
